...
// These can be be compared with ID's recieved from the server sent sound packets (generated by running player.dll code on the server)
...
// These can be be compared with ID's recieved from the server sent client-effects (generated by running player.dll code on the server)
