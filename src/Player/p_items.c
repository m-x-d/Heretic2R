...
#pragma region ========================== HEALTH ==========================
	...
	{ // 25
		...
		.world_model = "models/items/health/healthsmall/tris.fm", // World model (char *). //mxd. Used ONLY when the item is dropped via Drop_Item()...
		.mins = PICKUP_MIN,								// Bounding box mins.
		.maxs = PICKUP_MAX,								// Bounding box maxs.
	...
	{ // 26
		...
		.pickup_sound = "*gethealth.wav",				// Pickup sound (char *).
		.world_model = "models/items/health/healthbig/tris.fm", // World model (char *). //mxd. Used ONLY when the item is dropped via Drop_Item()...
		.mins = PICKUP_MIN,								// Bounding box mins.
		.maxs = PICKUP_MAX,								// Bounding box maxs.
