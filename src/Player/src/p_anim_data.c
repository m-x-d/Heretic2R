...
char* SeqNames[ASEQ_MAX] = //TODO: unused.
{
	...
	"ASEQ_JUMPFWD",
	"ASEQ_JUMPUP",
	"ASEQ_JUMPUP_LOOP", //BUGFIX: no comma after value in original version.
	"ASEQ_JUMPFLIPL",
	"ASEQ_JUMPFLIPR",
	"ASEQ_JUMPSPRINGBGO",
	"ASEQ_JUMPSPRINGB",
...
panimmove_t player_move_spellfireball = PANIMMOVE(player_frames_spellfireball, PlayerAnimUpperUpdate);
...
panimmove_t player_move_spellblast = PANIMMOVE(player_frames_spellblast, PlayerAnimUpperUpdate);
...
panimmove_t player_move_spellspherestart = PANIMMOVE(player_frames_spellspherestart, PlayerAnimUpperUpdate);
...
panimmove_t player_move_spellspherecharge = PANIMMOVE(player_frames_spellspherecharge, PlayerAnimUpperUpdate);
...
panimmove_t player_move_spellspherefire1 = PANIMMOVE(player_frames_spellspherefire1, PlayerAnimUpperUpdate);
...
panimmove_t player_move_spellspherefire2 = PANIMMOVE(player_frames_spellspherefire2, PlayerAnimUpperUpdate);
...
panimmove_t player_move_spellspherefire3 = PANIMMOVE(player_frames_spellspherefire3, PlayerAnimUpperUpdate);
...
panimmove_t player_move_spellripper = PANIMMOVE(player_frames_spellripper, PlayerAnimUpperUpdate);
...
panimmove_t player_move_bowready = PANIMMOVE(player_frames_bowready, PlayerAnimUpperUpdate);
...
panimmove_t player_move_rrbowdrawarrow = PANIMMOVE(player_frames_rrbowdrawarrow, PlayerAnimUpperUpdate);
...
panimmove_t player_move_phbowdrawarrow = PANIMMOVE(player_frames_phbowdrawarrow, PlayerAnimUpperUpdate);
...
panimmove_t player_move_bowholdarrow = PANIMMOVE(player_frames_bowholdarrow, PlayerAnimUpperUpdate);
...
panimmove_t player_move_rrbowfire = PANIMMOVE(player_frames_rrbowfire, PlayerAnimUpperUpdate);
...
panimmove_t player_move_phbowfire = PANIMMOVE(player_frames_phbowfire, PlayerAnimUpperUpdate);
...
panimmove_t player_move_bowholdready = PANIMMOVE(player_frames_bowholdready, PlayerAnimUpperUpdate);
...
panimmove_t player_move_hellready = PANIMMOVE(player_frames_hellready, PlayerAnimUpperUpdate);
...
panimmove_t player_move_hellfire1 = PANIMMOVE(player_frames_hellfire1, PlayerAnimUpperUpdate);
...
panimmove_t player_move_hellfire2 = PANIMMOVE(player_frames_hellfire2, PlayerAnimUpperUpdate);
...
static panimframe_t player_frames_spellchange[] =
{
	...
	{ FRAME_chngsplA6, NULL, 0, 0, 0, PlayerActionSpellChange, 0, NULL }, // Go to next spell.
...
panimmove_t player_move_drawsword = PANIMMOVE(player_frames_drawsword, PlayerAnimUpperUpdate);
...
panimmove_t player_move_drawhell = PANIMMOVE(player_frames_drawhell, PlayerAnimUpperUpdate);
...
panimmove_t player_move_stowsword = PANIMMOVE(player_frames_stowsword, PlayerAnimUpperUpdate);
...
panimmove_t player_move_sword2hell = PANIMMOVE(player_frames_sword2hell, PlayerAnimUpperUpdate); //mxd. numframes:8 in original logic.
...
panimmove_t player_move_sword2bow = PANIMMOVE(player_frames_sword2bow, PlayerAnimUpperUpdate);
...
panimmove_t player_move_stowhell = PANIMMOVE(player_frames_stowhell, PlayerAnimUpperUpdate);
...
panimmove_t player_move_hell2sword = PANIMMOVE(player_frames_hell2sword, PlayerAnimUpperUpdate);
...
panimmove_t player_move_hell2bow = PANIMMOVE(player_frames_hell2bow, PlayerAnimUpperUpdate);
...
panimmove_t player_move_stowbow = PANIMMOVE(player_frames_stowbow, PlayerAnimUpperUpdate);
...
panimmove_t player_move_bow2sword = PANIMMOVE(player_frames_bow2sword, PlayerAnimUpperUpdate);
...
panimmove_t player_move_bow2hell = PANIMMOVE(player_frames_bow2hell, PlayerAnimUpperUpdate);
...
panimmove_t player_move_staffatkspin = PANIMMOVE(player_frames_staffatkspin, PlayerAnimLowerUpdate);
...
panimmove_t player_move_staffatkspin2 = PANIMMOVE(player_frames_staffatkspin2, PlayerAnimLowerUpdate);
...
panimmove_t player_move_staffspinblockedright = PANIMMOVE(player_frames_staffspinblockedright, PlayerAnimLowerUpdate);
...
panimmove_t player_move_staffspinblockedleft = PANIMMOVE(player_frames_staffspinblockedleft, PlayerAnimLowerUpdate);
...
panimmove_t player_move_staffatkstand1 = PANIMMOVE(player_frames_staffatkstand1, PlayerAnimUpperUpdate);
...
panimmove_t player_move_staffatkstand2 = PANIMMOVE(player_frames_staffatkstand2, PlayerAnimUpperUpdate);
...
panimmove_t player_move_staffatkstep2 = PANIMMOVE(player_frames_staffatkstep2, PlayerAnimUpperUpdate);
...
panimmove_t player_move_staffatkstep = PANIMMOVE(player_frames_staffatkstep, PlayerAnimUpperUpdate);
...
panimmove_t player_move_staffatkback = PANIMMOVE(player_frames_staffatkback, PlayerAnimUpperUpdate);
...
panimmove_t player_move_staffdownstab = PANIMMOVE(player_frames_staffdownstab, PlayerAnimUpperUpdate);

static panimframe_t player_frames_staffstabhold[] =
{
	{ FRAME_spikedwn8, NULL, 0, 0, 0, PlayerActionSwordAttack, 22, NULL },
};
panimmove_t player_move_staffstabhold = PANIMMOVE(player_frames_staffstabhold, PlayerAnimUpperUpdate);
...
panimmove_t player_move_staffpullout = PANIMMOVE(player_frames_staffpullout, PlayerAnimUpperUpdate);
...
panimmove_t player_move_stafflowerdownstab = PANIMMOVE(player_frames_stafflowerdownstab, PlayerAnimLowerUpdate);
...
panimmove_t player_move_stafflowerpullout = PANIMMOVE(player_frames_stafflowerpullout, PlayerAnimLowerUpdate);
...
panimmove_t player_move_staffblockleft = PANIMMOVE(player_frames_staffblockleft, PlayerAnimUpperUpdate);
...
panimmove_t player_move_staffblockleft2 = PANIMMOVE(player_frames_staffblockleft2, PlayerAnimUpperUpdate);
...
panimmove_t player_move_staffblockleftatk = PANIMMOVE(player_frames_staffblockleftatk, PlayerAnimUpperUpdate);
...
panimmove_t player_move_staffblockright = PANIMMOVE(player_frames_staffblockright, PlayerAnimUpperUpdate);
...
panimmove_t player_move_staffblockright2 = PANIMMOVE(player_frames_staffblockright2, PlayerAnimUpperUpdate);
...
panimmove_t player_move_staffblockrightatk = PANIMMOVE(player_frames_staffblockrightatk, PlayerAnimUpperUpdate);
...
panimmove_t player_move_staffblockedleft = PANIMMOVE(player_frames_staffblockedleft, PlayerAnimUpperUpdate);
...
panimmove_t player_move_creepforward = PANIMMOVE(player_frames_creepforward, PlayerAnimLowerUpdate);
...
panimmove_t player_move_creepforward_end = PANIMMOVE(player_frames_creepforward_end, PlayerAnimLowerUpdate);
...
panimmove_t player_move_creepb_strafe_left = PANIMMOVE(player_frames_creepb_strafe_left, PlayerAnimLowerUpdate);
...
panimmove_t player_move_crouch_creep_forward = PANIMMOVE(player_frames_crouch_creep_forward, PlayerAnimLowerUpdate);
...
panimmove_t player_move_crouch_creep_back = PANIMMOVE(player_frames_crouch_creep_back, PlayerAnimLowerUpdate);
...
panimmove_t player_move_crouch_creep_left = PANIMMOVE(player_frames_crouch_creep_left, PlayerAnimLowerUpdate);
...
panimmove_t player_move_walkstart = PANIMMOVE(player_frames_walkstart, PlayerAnimLowerUpdate);
...
panimmove_t player_move_walk = PANIMMOVE(player_frames_walk, PlayerAnimLowerUpdate);
...
panimmove_t player_move_runstart = PANIMMOVE(player_frames_runstart, PlayerAnimLowerUpdate);
...
panimmove_t player_move_run = PANIMMOVE(player_frames_run, PlayerAnimLowerUpdate);
...
panimmove_t player_move_creepback = PANIMMOVE(player_frames_creepback, PlayerAnimLowerUpdate);
...
panimmove_t player_move_creepback_end = PANIMMOVE(player_frames_creepback_end, PlayerAnimLowerUpdate);
...
panimmove_t player_move_strafeleft = PANIMMOVE(player_frames_strafeleft, PlayerAnimLowerUpdate);
...
panimmove_t player_move_strafeleft_end = PANIMMOVE(player_frames_strafeleft_end, PlayerAnimLowerUpdate);
...
panimmove_t player_move_straferight = PANIMMOVE(player_frames_straferight, PlayerAnimLowerUpdate);
...
panimmove_t player_move_standjumpstart = PANIMMOVE(player_frames_standjumpstart, PlayerAnimLowerUpdate);
...
panimmove_t player_move_standjumpfwdstart = PANIMMOVE(player_frames_standjumpfwdstart, PlayerAnimLowerUpdate);
...
panimmove_t player_move_walkjumpfwdstart = PANIMMOVE(player_frames_walkjumpfwdstart, PlayerAnimLowerUpdate);
...
panimmove_t player_move_runjumpfwdstart = PANIMMOVE(player_frames_runjumpfwdstart, PlayerAnimLowerUpdate);
...
panimmove_t player_move_jumpfwd = PANIMMOVE(player_frames_jumpfwd, PlayerAnimLowerUpdate);
...
panimmove_t player_move_jumpup = PANIMMOVE(player_frames_jumpup, PlayerAnimLowerUpdate);
...
panimmove_t player_move_jumpuploop = PANIMMOVE(player_frames_jumpuploop, NULL);
...
panimmove_t player_move_standjumpbackstart = PANIMMOVE(player_frames_standjumpbackstart, PlayerAnimLowerUpdate);
...
panimmove_t player_move_walkjumpbackstart = PANIMMOVE(player_frames_walkjumpbackstart, PlayerAnimLowerUpdate);
...
panimmove_t player_move_runjumpbackstart = PANIMMOVE(player_frames_runjumpbackstart, PlayerAnimLowerUpdate);
...
panimmove_t player_move_jumpback = PANIMMOVE(player_frames_jumpback, PlayerAnimLowerUpdate);
...
panimmove_t player_move_jumpbackflip = PANIMMOVE(player_frames_jumpflipback, PlayerAnimLowerUpdate);
...
panimmove_t player_move_standjumpleftstart = PANIMMOVE(player_frames_standjumpleftstart, PlayerAnimLowerUpdate);
...
panimmove_t player_move_walkjumpleftstart = PANIMMOVE(player_frames_walkjumpleftstart, PlayerAnimLowerUpdate);
...
panimmove_t player_move_runjumpleftstart = PANIMMOVE(player_frames_runjumpleftstart, PlayerAnimLowerUpdate);
...
panimmove_t player_move_jumpleft = PANIMMOVE(player_frames_jumpleft, PlayerAnimLowerUpdate);
...
panimmove_t player_move_jumpleftflip = PANIMMOVE(player_frames_jumpleftflip, PlayerAnimLowerUpdate);
...
panimmove_t player_move_standjumprightstart = PANIMMOVE(player_frames_standjumprightstart, PlayerAnimLowerUpdate);
...
panimmove_t player_move_walkjumprightstart = PANIMMOVE(player_frames_walkjumprightstart, PlayerAnimLowerUpdate);
...
panimmove_t player_move_runjumprightstart = PANIMMOVE(player_frames_runjumprightstart, PlayerAnimLowerUpdate);
...
panimmove_t player_move_jumpright = PANIMMOVE(player_frames_jumpright, PlayerAnimLowerUpdate);
...
panimmove_t player_move_land1 = PANIMMOVE(player_frames_land1, PlayerAnimLowerUpdate);
...
panimmove_t player_move_crouchdown = PANIMMOVE(player_frames_crouchdown, PlayerAnimLowerUpdate);
...
panimmove_t player_move_crouch = PANIMMOVE(player_frames_crouch, PlayerAnimLowerUpdate);
...
panimmove_t player_move_rolldivefwdwalk = PANIMMOVE(player_frames_rolldivefwdwalk, PlayerAnimLowerUpdate);
...
panimmove_t player_move_polevault1walk = PANIMMOVE(player_frames_polevault1walk, PlayerAnimLowerUpdate);
...
panimmove_t player_move_polevault1run = PANIMMOVE(player_frames_polevault1run, PlayerAnimLowerUpdate);
...
static panimframe_t player_frames_sswimidle[] =
{
	...
	{ FRAME_idlswm8,  NULL, 0, 0, 0, NULL, 0, PlayerAnimLowerIdle },
...
panimmove_t player_move_sswimidle = PANIMMOVE(player_frames_sswimidle, NULL);
...
panimmove_t player_move_sswimfwdgo = PANIMMOVE(player_frames_sswimfwdgo, PlayerAnimLowerUpdate);
...
static panimframe_t player_frames_sswimfwd[] =
{
	...
	{ FRAME_4swim5, PlayerSwimMoveFunc, 190, 0, 0, NULL, 0, NULL },
...
panimmove_t player_move_sswimfwd = PANIMMOVE(player_frames_sswimfwd, PlayerAnimLowerUpdate);
...
panimmove_t player_move_sswimfwdstop = PANIMMOVE(player_frames_sswimfwdstop, PlayerAnimLowerUpdate);
...
panimmove_t player_move_sswimbackgo = PANIMMOVE(player_frames_sswimbackgo, PlayerAnimLowerUpdate);
...
static panimframe_t player_frames_sswimback[] =
{
	...
	{ FRAME_bkswim4, PlayerSwimMoveFunc, -150, 0, 0, NULL, 0, NULL },
...
panimmove_t player_move_sswimback = PANIMMOVE(player_frames_sswimback, PlayerAnimLowerUpdate);
...
panimmove_t player_move_sswimbackstop = PANIMMOVE(player_frames_sswimbackstop, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_sswim_left_go = PANIMMOVE(player_frames_sswim_left_go, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_sswim_right_go = PANIMMOVE(player_frames_sswim_right_go, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_sswim_left = PANIMMOVE(player_frames_sswim_left, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_sswim_right = PANIMMOVE(player_frames_sswim_right, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_sswim_left_stop = PANIMMOVE(player_frames_sswim_left_stop, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_sswim_right_stop = PANIMMOVE(player_frames_sswim_right_stop, PlayerAnimLowerUpdate);
...
panimmove_t player_move_swim_fast_go = PANIMMOVE(player_frames_swim_fast_go, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_uswimfwd_go = PANIMMOVE(player_frames_uswimfwd_go, PlayerAnimLowerUpdate);
...
panimmove_t player_move_uswimfwd = PANIMMOVE(player_frames_uswimfwd, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_uswimfwd_end = PANIMMOVE(player_frames_uswimfwd_end, PlayerAnimLowerUpdate);
...
panimmove_t player_move_uswimbackgo = PANIMMOVE(player_frames_uswimbackgo, PlayerAnimLowerUpdate);
...
static panimframe_t player_frames_uswimback[] =
{
	...
	{ FRAME_subckswm4, PlayerSwimMoveFunc, -250, 0, 0, NULL, 0, NULL },
...
panimmove_t player_move_uswimback = PANIMMOVE(player_frames_uswimback, PlayerAnimLowerUpdate);
...
panimmove_t player_move_uswimbackstop = PANIMMOVE(player_frames_uswimbackstop, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_uswim_left_go = PANIMMOVE(player_frames_uswim_left_go, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_uswim_right_go = PANIMMOVE(player_frames_uswim_right_go, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_uswim_left = PANIMMOVE(player_frames_uswim_left, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_uswim_right = PANIMMOVE(player_frames_uswim_right, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_uswim_left_stop = PANIMMOVE(player_frames_uswim_left_stop, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_uswim_right_stop = PANIMMOVE(player_frames_uswim_right_stop, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_idle_under = PANIMMOVE(player_frames_idle_under, NULL);
...
panimmove_t player_move_dive1 = PANIMMOVE(player_frames_dive1, PlayerAnimLowerUpdate);
...
panimmove_t player_move_pullupwall = PANIMMOVE(player_frames_pullupwall, PlayerAnimLowerUpdate);
...
panimmove_t player_move_pulluphalfwall = PANIMMOVE(player_frames_pulluphalfwall, PlayerAnimLowerUpdate);
...
panimmove_t player_move_vaultwall = PANIMMOVE(player_frames_vaultwall, PlayerAnimLowerUpdate); //mxd. numframes:10 in original logic.
...
panimmove_t player_move_vaulthigh = PANIMMOVE(player_frames_vaulthigh, PlayerAnimLowerUpdate); //mxd. numframes:10 in original logic.
...
panimmove_t player_move_jumpfliphandspringgo = PANIMMOVE(player_frames_jumpfliphandspringgo, PlayerAnimLowerUpdate);
...
panimmove_t player_move_takepuzzlepiece = PANIMMOVE(player_frames_takepuzzlepiece, PlayerAnimLowerUpdate);
...
panimmove_t player_move_takepuzzleunderwater = PANIMMOVE(player_frames_takepuzzleunderwater, PlayerAnimLowerUpdate);
...
panimmove_t player_move_pushbuttongo = PANIMMOVE(player_frames_pushbuttongo, PlayerAnimLowerUpdate);
...
panimmove_t player_move_pushleverleft = PANIMMOVE(player_frames_pushleverleft, PlayerAnimLowerUpdate);
...
panimmove_t player_move_tumbleon1 = PANIMMOVE(player_frames_tumbleon1, PlayerAnimLowerUpdate);
...
panimmove_t player_move_crouchpivotleft = PANIMMOVE(player_frames_crouchpivotleft, PlayerAnimLowerUpdate);
...
panimmove_t player_move_jumpflipleft = PANIMMOVE(player_frames_jumpflipleft, PlayerAnimLowerUpdate);
...
panimmove_t player_move_jumpflipright = PANIMMOVE(player_frames_jumpflipright, PlayerAnimLowerUpdate);
...
panimmove_t player_move_rollfromfflip = PANIMMOVE(player_frames_rollfromfflip, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_forward_flip_l_go = PANIMMOVE(player_frames_forward_flip_l_go, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_forward_flip_r_go = PANIMMOVE(player_frames_forward_flip_r_go, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_forward_flip_l = PANIMMOVE(player_frames_forward_flip_l, PlayerAnimLowerUpdate);
...
panimmove_t player_move_lstair4 = PANIMMOVE(player_frames_lstair4, PlayerAnimLowerUpdate);

static panimframe_t player_frames_lstair8[] = { FRAME_Lstair2, NULL, 0, 0, 0, NULL, 0, NULL };
panimmove_t player_move_lstair8 = PANIMMOVE(player_frames_lstair8, PlayerAnimLowerUpdate);

static panimframe_t player_frames_lstair12[] = { FRAME_Lstair3, NULL, 0, 0, 0, NULL, 0, NULL };
panimmove_t player_move_lstair12 = PANIMMOVE(player_frames_lstair12, PlayerAnimLowerUpdate);

static panimframe_t player_frames_lstair16[] = { FRAME_Lstair4, NULL, 0, 0, 0, NULL, 0, NULL };
panimmove_t player_move_lstair16 = PANIMMOVE(player_frames_lstair16, PlayerAnimLowerUpdate);

// Right.
static panimframe_t player_frames_rstair4[] = { FRAME_Rstair1, NULL, 0, 0, 0, NULL, 0, NULL };
panimmove_t player_move_rstair4 = PANIMMOVE(player_frames_rstair4, PlayerAnimLowerUpdate);

static panimframe_t player_frames_rstair8[] = { FRAME_Rstair2, NULL, 0, 0, 0, NULL, 0, NULL };
panimmove_t player_move_rstair8 = PANIMMOVE(player_frames_rstair8, PlayerAnimLowerUpdate);

static panimframe_t player_frames_rstair12[] = { FRAME_Rstair3, NULL, 0, 0, 0, NULL, 0, NULL };
panimmove_t player_move_rstair12 = PANIMMOVE(player_frames_rstair12, PlayerAnimLowerUpdate);
...
panimmove_t player_move_stand = PANIMMOVE(player_frames_stand, PlayerAnimLowerUpdate);
...
panimmove_t player_move_standreadystart = PANIMMOVE(player_frames_standreadystart, PlayerAnimLowerUpdate);
...
panimmove_t player_move_standready = PANIMMOVE(player_frames_standready, PlayerAnimLowerUpdate);
...
panimmove_t player_move_standreadyend = PANIMMOVE(player_frames_standreadyend, PlayerAnimLowerUpdate);
...
panimmove_t player_move_standlookleft = PANIMMOVE(player_frames_standlookleft, PlayerAnimLowerUpdate);
...
panimmove_t player_move_standlookright = PANIMMOVE(player_frames_standlookright, PlayerAnimLowerUpdate);
...
panimmove_t player_move_pest1 = PANIMMOVE(player_frames_pest1, PlayerAnimLowerUpdate);
...
panimmove_t player_move_pest2 = PANIMMOVE(player_frames_pest2, PlayerAnimLowerUpdate);
...
panimmove_t player_move_idle_lookback = PANIMMOVE(player_frames_idle_lookback, PlayerAnimLowerUpdate);
...
panimmove_t player_move_idle_scratch_ass = PANIMMOVE(player_frames_idle_scratch_ass, PlayerAnimLowerUpdate);
...
panimmove_t player_move_paina = PANIMMOVE(player_frames_paina, PlayerAnimLowerUpdate);
...
panimmove_t player_move_fallleft = PANIMMOVE(player_frames_fallleft, PlayerAnimLowerUpdate);
...
panimmove_t player_move_fallright = PANIMMOVE(player_frames_fallright, PlayerAnimLowerUpdate);
...
panimmove_t player_move_fallleftend = PANIMMOVE(player_frames_fallleftend, PlayerAnimLowerUpdate);
...
panimmove_t player_move_death1 = PANIMMOVE(player_frames_death1, PlayerAnimLowerUpdate);
...
panimmove_t player_move_death_b = PANIMMOVE(player_frames_death_b, PlayerAnimLowerUpdate);
...
panimmove_t player_move_death_fly_forward = PANIMMOVE(player_frames_death_fly_forward, PlayerAnimLowerUpdate);
...
panimmove_t player_move_death_fly_back = PANIMMOVE(player_frames_death_fly_back, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_drown = PANIMMOVE(player_frames_drown, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_slide_forward = PANIMMOVE(player_frames_slide_forward, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_roll_l = PANIMMOVE(player_frames_roll_l, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_roll_r = PANIMMOVE(player_frames_roll_r, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_climb_on = PANIMMOVE(player_frames_climb_on, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_climb_hold_r = PANIMMOVE(player_frames_climb_hold_r, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_climb_hold_l = PANIMMOVE(player_frames_climb_hold_l, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_climb_up_start_r = PANIMMOVE(player_frames_climb_up_start_r, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_climb_up_r = PANIMMOVE(player_frames_climb_up_r, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_climb_settle_r = PANIMMOVE(player_frames_climb_settle_r, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_climb_settle_l = PANIMMOVE(player_frames_climb_settle_l, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_knockdown = PANIMMOVE(player_frames_knockdown, PlayerAnimLowerUpdate);
...
panimmove_t	player_move_knockdown_getup = PANIMMOVE(player_frames_knockdown_getup, PlayerAnimLowerUpdate);
...
panimmove_t player_move_run_strafe_right = PANIMMOVE(player_frames_run_strafe_right, PlayerAnimLowerUpdate);
...
panimmove_t player_move_walkb_strafe_left = PANIMMOVE(player_frames_walkb_strafe_left, PlayerAnimLowerUpdate);
...
panimmove_t player_move_dash_left_go = PANIMMOVE(player_frames_dash_left_go, PlayerAnimLowerUpdate);
...
panimmove_t player_move_dash_right_go = PANIMMOVE(player_frames_dash_right_go, PlayerAnimLowerUpdate);
