...
#define VERSIONDISP			"R1" // Shown in console. //mxd. (VERSION_MAJOR"."VERSION_MINOR) in original logic.
...
extern void MSG_WriteRemoveEntity(sizebuf_t* sb, int ent_num, qboolean write_ent_freed_flag); //mxd
