//
// ce_Effects.h -- Named 'Client Effects.h' in original logic --mxd.
//
...
extern void FXCompass(centity_t* owner, int type, int flags, vec3_t origin); //mxd
...
extern void PreCachePhoenixExplode(void);
extern void PreCachePhoenixExplodeSFX(void); //mxd
extern void PreCachePhoenixMissile(void); //mxd
...
extern void PreCacheCompass(void); //mxd