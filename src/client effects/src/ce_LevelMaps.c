//
// ce_LevelMaps.c -- Named 'LevelMaps.c' in original logic --mxd.
//
...
static level_map_info_t LevelMaps[MAX_MAPS] =
{
	{ 0, 0, NULL, NULL, 0, 0, 0, 0, 0, 0 }, // level 0 - undefined //TODO: why are there 2 undefined entries?..
