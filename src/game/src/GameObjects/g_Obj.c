...
#include "Monsters/g_Monster.h" //mxd
#include "Monsters/m_Move.h" //mxd
#include "Monsters/m_Stats.h"
#include "Monsters/PlagueElf/m_PlagueElf.h" //mxd. For PlagueElfDyingSound().
#include "Monsters/PlagueElf/m_PlagueElf_anim.h"
#include "Random.h"
#include "Vector.h"
