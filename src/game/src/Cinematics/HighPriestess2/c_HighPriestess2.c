//
// c_HighPriestess2.c -- Named 'c_priestess2.c' in original logic --mxd.
//
// Copyright 1998 Raven Software
//

#include "c_HighPriestess2.h"
#include "c_HighPriestess2_anim.h"
#include "c_HighPriestess2_moves.h"
