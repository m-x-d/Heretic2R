//
// p_Weapons.c -- Generic weapon handling code for all player weapons. Named 'g_weapon.c' in original logic --mxd.
//
// Copyright 1998 Raven Software
//

#include "p_Weapons.h" //mxd
#include "p_anims.h"
#include "p_main.h"
...
#include "SpellsOffensive/spl_ThunderBlast.h" //mxd
#include "SpellsOffensive/spl_Fireball.h" //mxd
#include "SpellsOffensive/spl_HellStaff.h" //mxd
#include "SpellsOffensive/spl_Maceball.h" //mxd
#include "SpellsOffensive/spl_MagicMissile.h" //mxd
#include "SpellsOffensive/spl_Phoenix.h" //mxd
#include "SpellsOffensive/spl_RedRain.h" //mxd
#include "SpellsOffensive/spl_Ripper.h" //mxd
#include "SpellsOffensive/spl_SphereOfAnnihilation.h" //mxd
#include "SpellsOffensive/spl_FireWall.h" //mxd
#include "Matrix.h"
#include "Random.h"
#include "Reference.h"
#include "Vector.h"
