//
// p_Items.c -- Named 'p_item.c' in original logic --mxd.
//
...
#include "SpellsDefensive/spl_TomeOfPower.h" //mxd
#include "SpellsDefensive/spl_LightningShield.h" //mxd
#include "SpellsDefensive/spl_Teleport.h" //mxd
#include "SpellsDefensive/spl_Tornado.h" //mxd
#include "g_Local.h"
