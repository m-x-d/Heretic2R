//
// g_Utilities.h -- Named 'Utilities.h' in original logic --mxd.
//
...
extern void AdjustAimAngles(const edict_t* caster, const vec3_t start_pos, const vec3_t aim_angles, float view_offset_z, vec3_t angles); //mxd
