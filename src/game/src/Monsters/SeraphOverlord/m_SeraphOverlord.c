...
#include "m_SeraphOverlord.h"
#include "m_SeraphOverlord_shared.h"
#include "m_SeraphOverlord_anim.h"
#include "m_SeraphOverlord_moves.h"
...
void SP_monster_seraph_overlord(edict_t* self)
{
	...
	self->s.fmnodeinfo[MESH__GUARDHEAD].flags |= FMNI_NO_DRAW; //mxd. Unfinished texture.
	...
	self->s.fmnodeinfo[MESH__SHOULDPAD].flags |= FMNI_NO_DRAW; //mxd. Unfinished texture.
