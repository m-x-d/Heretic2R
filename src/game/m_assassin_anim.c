...
const animmove_t assassin_move_evade_backflip = { 7, assassin_frames_evade_backflip, assassin_go_bfinair };
...
const animmove_t assassin_move_backflip = { 12, assassin_frames_backflip, assassin_go_bfinair };
