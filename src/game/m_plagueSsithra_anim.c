...
const animmove_t ssithra_move_sliced = ANIMMOVE(ssithra_frames_sliced, ssithra_dead); //mxd. endfunc:ssithra_kill_self in original logic (caused already dead ssithra to play different death animation again).
