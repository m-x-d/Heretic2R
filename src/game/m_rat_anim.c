...
const animmove_t rat_move_run1 = { 5, rat_frames_run1, rat_runorder };
...
const animmove_t rat_move_run2 = { 4, rat_frames_run2, rat_runorder };
...
const animmove_t rat_move_stand1 = { 8, rat_frames_stand1, rat_standorder };
...
const animmove_t rat_move_stand2 = { 10, rat_frames_stand2, rat_standorder };
...
const animmove_t rat_move_stand3 = { 7, rat_frames_stand3, rat_standorder };
...
const animmove_t rat_move_stand4 = { 5, rat_frames_stand4, rat_standorder };
...
const animmove_t rat_move_stand5 = { 5, rat_frames_stand5, rat_standorder };
...
static const animframe_t rat_frames_stand6[] =
{
	...
	{ FRAME_haunch34,	NULL, 0, 0, 0, NULL,			0, ratscratch },
	{ FRAME_haunch35,	NULL, 0, 0, 0, rat_ai_stand,	0, NULL },
	{ FRAME_haunch36,	NULL, 0, 0, 0, NULL,			0, NULL },
};
const animmove_t rat_move_stand6 = { 5, rat_frames_stand6, rat_standorder };
...
static const animframe_t rat_frames_stand7[] =
{
	...
	{ FRAME_haunch40,	NULL, 0, 0, 0, NULL,			0, ratscratch },
	{ FRAME_haunch41,	NULL, 0, 0, 0, rat_ai_stand,	0, NULL },
	{ FRAME_haunch42,	NULL, 0, 0, 0, NULL,			0, NULL },
};
const animmove_t rat_move_stand7 = { 5, rat_frames_stand7, rat_standorder };
...
const animmove_t rat_move_stand8 = { 6, rat_frames_stand8, rat_standorder }; //mxd. .numframes: 5 in original logic.
...
const animmove_t rat_move_watch1 = { 16, rat_frames_watch1, rat_eatorder };
...
const animmove_t rat_move_watch2 = { 13, rat_frames_watch2, rat_eatorder };
...
const animmove_t rat_move_eat2 = { 13, rat_frames_eat2, rat_eatorder };
