...
const animmove_t gorgon_move_stand4 = {8, gorgon_frames_stand4, gorgon_check_mood};
...
const animmove_t gorgon_move_melee9 = {10, gorgon_frames_melee9, gorgon_check_mood};
...
const animmove_t gorgon_move_melee8 = {10, gorgon_frames_melee8, gorgon_check_mood};
...
const animmove_t gorgon_move_melee7 = {10, gorgon_frames_melee7, gorgon_check_mood};
...
{ //FIXME: add wake and bubbles and sploosh swim sounds
	...
	FRAME_jumpb8,	NULL, 0, 0, 0, gorgon_forward, 100,  gorgonFixPitch,
	FRAME_jumpb9,	NULL, 0, 0, 0, gorgon_forward, 100,  gorgonFixPitch,
	FRAME_jumpb10,	NULL, 0, 0, 0, gorgon_forward, 100,  gorgonFixPitch,
	FRAME_jumpb11,	NULL, 0, 0, 0, gorgon_forward, 100,  gorgonFixPitch,
	FRAME_jumpb12,	NULL, 0, 0, 0, gorgon_forward, 100,  gorgonFixPitch,
	FRAME_jumpb13,	NULL, 0, 0, 0, gorgon_forward, 100,  gorgonFixPitch,
	FRAME_jumpb14,	NULL, 0, 0, 0, gorgon_forward, 100,  gorgonFixPitch,
