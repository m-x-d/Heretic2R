...
const animmove_t elflord_move_wait = { 24, elflord_frames_wait, elfLordCheckAttack };
...
const animmove_t elflord_move_come_to_life = { 35, elflord_frames_come_to_life, elfLordCheckAttack };