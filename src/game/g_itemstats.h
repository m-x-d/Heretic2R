...
#define LIGHT_DURATION				90	// Duration of shrine light on player - in seconds.
#define REFLECT_DURATION_SINGLE		30	// Duration of shrine reflect on player - in seconds.
#define REFLECT_DURATION_DEATHMATCH	20	// Duration of shrine reflect on player - in seconds.
#define GHOST_DURATION				60	// Duration of shrine ghosting on player - in seconds.
#define POWERUP_DURATION			30	// Duration of shrine powerup on player weapons - in seconds.
#define LUNGS_DURATION				20	// Duration of shrine lungs on player - in seconds.
#define SHRINE_DELAY				45	// Time till Shrine is useable again if so toggled - in seconds.
#define SPEED_DURATION				25	// Duration of shrine speed on player - in seconds.
