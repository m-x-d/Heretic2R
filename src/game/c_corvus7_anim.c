...
const animmove_t corvus7_move_c_action1 = { 40, corvus7_frames_c_action1, ai_c_cycleend };
...
const animmove_t corvus7_move_c_action2 = { 16, corvus7_frames_c_action2, ai_c_cycleend };
...
const animmove_t corvus7_move_c_action3 = { 14, corvus7_frames_c_action3, ai_c_cycleend };
...
const animmove_t corvus7_move_c_idle1 = { 23, corvus7_frames_c_idle1, ai_c_cycleend };
...
const animmove_t corvus7_move_c_idle2 = { 12, corvus7_frames_c_idle2, ai_c_cycleend };
...
const animmove_t corvus7_move_c_idle3 = { 12, corvus7_frames_c_idle3, ai_c_cycleend };
...
const animmove_t corvus7_move_c_pivotleftgo = { 2, corvus7_frames_c_pivotleftgo, ai_c_cycleend };
...
const animmove_t corvus7_move_c_pivotleft = { 2, corvus7_frames_c_pivotleft, ai_c_cycleend };

static const animframe_t corvus7_frames_c_pivotleftstop[] =
{
	{ FRAME_Lpivot4, ai_c_move, 0, 0, 0, NULL, 0, NULL },
};
const animmove_t corvus7_move_c_pivotleftstop = { 1, corvus7_frames_c_pivotleftstop, ai_c_cycleend };
...
const animmove_t corvus7_move_c_pivotrightgo = { 2, corvus7_frames_c_pivotrightgo, ai_c_cycleend };
...
const animmove_t corvus7_move_c_pivotright = { 2, corvus7_frames_c_pivotright, ai_c_cycleend };

static const animframe_t corvus7_frames_c_pivotrightstop[] =
{
	{ FRAME_Lpivot1, NULL, 0, 0, 0, NULL, 0, NULL },
};
const animmove_t corvus7_move_c_pivotrightstop = { 1, corvus7_frames_c_pivotrightstop, ai_c_cycleend };
...
const animmove_t corvus7_move_c_walk1 = { 8, corvus7_frames_c_walk1, ai_c_cycleend };
...
const animmove_t corvus7_move_c_walk2 = { 16, corvus7_frames_c_walk2, ai_c_cycleend };
...
const animmove_t corvus7_move_c_walkstart = { 2, corvus7_frames_c_walkstart, ai_c_cycleend };
...
const animmove_t corvus7_move_c_walkstop1 = { 2, corvus7_frames_c_walkstop1, ai_c_cycleend };
...
const animmove_t corvus7_move_c_walkstop2 = { 2, corvus7_frames_c_walkstop2, ai_c_cycleend };